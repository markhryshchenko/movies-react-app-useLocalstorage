...
export default function AddNewFilm() {
  ...
  const [upImgLink, setUpImgLink] = React.useState('https://upload.wikimedia.org/wikipedia/commons/0/0e/Felis_silvestris_silvestris.jpg');
      ...
      <main className={styles.main}>
        <div className={styles.new_item_box}>
          <div className={styles.img__box}>
            <img src={upImgLink} className={styles.item__img} alt="img" />
            <button onClick={uploadImg} className={styles.item__btn}>Upload image</button>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={styles.item__form}>
            <div className={styles.details__column}>
              ...
              <div>
                ...
                />
                <p className={styles.infoImg}>Paste your link or use default</p>
                <div className={styles.error__field}>
                  {errors?.title && <p>This field is required</p>}
                </div>
              </div>
